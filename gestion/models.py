...
class Categoria(models.Model):
    ...
    imagen = models.OneToOneField(
        to=Imagen, on_delete=models.RESTRICT, db_column='imagen_id', related_name='categoria')
...
class Producto(models.Model):
    ...
    categoria = models.ForeignKey(
        to=Categoria, on_delete=models.CASCADE, db_column='categoria_id', related_name='productos')
    imagen = models.OneToOneField(
        to=Imagen, on_delete=models.RESTRICT, db_column='imagen_id', related_name='producto')
...
class ManejoUsuario(BaseUserManager):
    ...
    def create_superuser(self, nombre, apellido, email, password, tipo):
        ...
        nuevoUsuario = self.model(
            email=emailNormalizado, nombre=nombre, tipo=tipo, apellido=apellido)
